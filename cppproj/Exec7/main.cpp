...
int main()
{
    ...
    //Listing 7.9
    //функци€ со строковым аргументом
    /*char mmm[15] = "minimum";
    char *wail = "ululate";
    ...
    //Listing 7.10
    //функци€, возвращающа€ указатель на char
    /*int times;
    char ch;
    cin >> ch;
    cin >> times;
    ...
    //Listing 7.11
    //использование структур с функци€ми
    ...
    //”пражнение 2
    /*cout << "¬ведите до 10 результатов игры в гольф, дл€ прекращени€ ввода "
            "нажмите q\n";
    const int size = 10;
    int golf[size];
    ...
    cout << "¬ведите общее количество номеров и количество номеров, которые нужно угадать\n";
    while ((cin >> total >> choices) && choices <= total) {
        tot_shans = tot_shans * probability(total, choices);
        //cout << probability(total, choices) << endl;
        cout << "\nћеганомер ()q дл€ завершени€: ";
    };

    cout << "¬еро€тность выигрыша: " << tot_shans << endl;*/
    ...
    if ( properties  <  end )
    {
        ...
        while  (!(cin >> factor ))
        {
            ...
            while (cin.get() != '\n')
                continue;
            cout  <<  "Bad input; Please enter а num№er : ";  // повторный  запрос  на  ввод числа
        }
...
int setArray(int ar[], int size)
{
    ...
    cout << "ƒл€ прекращени€ ввода введите отрицательное значение\n";
